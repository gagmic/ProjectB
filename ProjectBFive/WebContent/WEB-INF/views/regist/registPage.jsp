...
<link href="/ProjectBFive/resources/styleRegist.css" rel="stylesheet" type="text/css">
<link href="/ProjectBFive/resources/js/jqueryui/jquery-ui.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="dialog">
	<div id="search">
...
<h3 align="center">회원 가입 화면</h3>
   <form:form action="/ProjectBFive/regist/register" method="post" 
   commandName="vo">
