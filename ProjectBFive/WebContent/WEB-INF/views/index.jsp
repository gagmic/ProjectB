		...
		<nav class="navbar navbar-default">
			...
			<!-- Brand and toggle get grouped for better mobile display -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/ProjectBFive/">YEN1</a>
				</div> <!-- /.navbar-header -->

		    <!-- Collect the nav links, forms, and other content for toggling -->
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						<li class="active"><a href="/ProjectBFive/">Intro</a></li>
						<li><a href="/ProjectBFive/index/about">Who I Am</a></li>
...
<!-- Footer -->
	...
	<script src="/ProjectBFive/resources/assets/js/jquery-1.11.2.min.js"></script>
    <script src="/ProjectBFive/resources/assets/js/bootstrap.min.js"></script>
    <script src="/ProjectBFive/resources/assets/js/owl.carousel.min.js"></script>
    <script src="/ProjectBFive/resources/assets/js/contact.js"></script>
	<script src="/ProjectBFive/resources/assets/js/script.js"></script>
